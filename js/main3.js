...
function initSigma(config) {
    ...
    dataReady = function() {//This is called as soon as data is loaded
		...
		a.draw();
		configSigmaElements(config);//colors are correct
	}
...
function nodeActive(a) {
            //console.trace("what is nodeActive " + (a))
    ...
    sigInst.iterEdges(function (b) {
        b.attr.lineWidth = !1;
        b.hidden = !0;
        //console.trace("what is a search: " + JSON.stringify((b)));
        
        n={
            name: b.label,
            colour: b.color
        };
                //console.trace("what is n " + (n))
		...
		for (g in e) {
			...
			if (c.colour == "rgb(255,0,0)") {//project
				...
				f.push('<li class="cf" rel="' + c.group + '"><div class=""></div><div class="">' + d + "</div></li>");
                        ...
                        if (c.colour == "rgb(0,0,204)") {//blue=people
                            h1 = c.name;
				//d = c.colour;
				f.push('<li class="cf" rel="' + c.group + '"><div class=""></div><div class="">' + d + "</div></li>");
                        ...
                        if (c.colour == "rgb(255,0,255)") { //publication
                            h1 = c.name;
				//d = c.colour;
				f.push('<li class="cf" rel="' + c.group + '"><div class=""></div><div class="">' + d + "</div></li>");
                        ...
                        if (c.colour == "rgb(255,200,0)") { //yellow = organization
                            h1 = c.name;
				//d = c.colour;
				f.push('<li class="cf" rel="' + c.group + '"><div class=""></div><div class="">' + d + "</div></li>");
                ...
                f = f1.concat("<h2>Projects</h2>", f2, "<h2>People</h2>", f3, "<h2>Publications</h2>", f4, "<h2>Organizations</h2>", f5);
