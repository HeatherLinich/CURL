...
function configSigmaElements(config) {
    ...
    a.sort();
    //  left menu bar sort of people, projects, etc console.log("what is a " + JSON.stringify(a))
...
function nodeActive(a) {
    ...
    e.sort(function (a, b) {
        var c = a.group.toLowerCase(),
            ...
            //here is the sorting for connections
